...
$DBTYPE='sqlite'; //-- type of database to connect when using the PHP/PDO
...
$DBNAME='/var/www/html/data/phpgedview.sqlite'; //-- The MySQL database name where you want PHPGedView to build its tables
$DB_UTF8_COLLATION=true; //-- Use the database to sort/collation UTF8 text
$TBLPREFIX='pgv_'; //-- prefix to include on table names
$INDEX_DIRECTORY='/var/www/html/data/'; //-- Readable and Writeable Directory to store index files (include the trailing "/")
...
$PGV_SMTP_AUTH_USER='smtp_user'; //-- User name for SMTP authorization
$PGV_SMTP_AUTH_PASS='your_secure_password'; //-- Password for SMTP authorization
