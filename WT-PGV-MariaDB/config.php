...
$DBUSER='webtrees'; //-- MySQL database User Name
$DBPASS='baddbpassword'; //-- MySQL database User Password
$DBNAME='webtrees'; //-- The MySQL database name where you want PHPGedView to build its tables
